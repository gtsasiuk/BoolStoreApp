...
(2, 'jane.smith@email.com', 'Jane Smith', 'abc456'),
(3, 'bob.jones@email.com', 'Bob Jones', 'qwerty789'),
(4, 'alice.white@email.com', 'Alice White', 'secret567'),
(5, 'mike.wilson@email.com', 'Mike Wilson', 'mypassword'),
(6, 'sara.brown@email.com', 'Sara Brown', 'letmein123'),
(7, 'tom.jenkins@email.com', 'Tom Jenkins', 'pass4321'),
(8, 'lisa.taylor@email.com', 'Lisa Taylor', 'securepwd'),
(9, 'david.wright@email.com', 'David Wright', 'access123'),
(10,'emily.harris@email.com', 'Emily Harris', '1234abcd'),

(11,'client1@example.com', 'Medelyn Wright', 'password123'),
(12,'client2@example.com', 'Landon Phillips', 'securepass'),
(13,'client3@example.com', 'Harmony Mason', 'abc123'),
(14,'client4@example.com', 'Archer Harper', 'pass456'),
(15,'client5@example.com', 'Kira Jacobs', 'letmein789'),
(16,'client6@example.com', 'Maximus Kelly', 'adminpass'),
(17,'client7@example.com', 'Sierra Mitchell', 'mypassword'),
(18,'client8@example.com', 'Quinton Saunders', 'test123'),
(19,'client9@example.com', 'Amina Clarke', 'qwerty123'),
(20,'client10@example.com','Bryson Chavez', 'pass789');
